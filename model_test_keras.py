...
def test_model(model, data, LABEL_SET):
    """
    ...
    labels.
    """
    X_test, y_test = get_convoluted_data(data, LABEL_SET)
    ...
    for actual, predicted in zip(y_test, y_predicted):
        print("Actual: ", one_hot_to_label(actual, LABEL_SET), "\t Predicted: ", one_hot_to_label(predicted, LABEL_SET))
